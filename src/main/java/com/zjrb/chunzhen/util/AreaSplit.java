...
//                }
     ...
     * @return
     */
    public IPEntry getArea(String areaStr,Boolean isTest){
...
//                        }
    ...
    public static void main(String[] args) throws Exception {
        if(args.length>0 && ("help".equals(args[0]) || "--help".equals(args[0]) || "-help".equals(args[0]))){
            System.out.println("com.zjrb.chunzhen.util.AreaSplit inputFilePath outputFilePath encoding");
            ...
            System.out.println("encoding: 写入时采用的编码格式，因为之后要导入到数据库建议UTF-8，默认与输入文本的格式相同");
        }
        if(args.length!=3){
            System.out.println("输入错误！！！必须要有参数");
            System.out.println(args[0]+"----"+args[1]+"----"+args[2] );
            System.out.println("eg: com.zjrb.chunzhen.util.AreaSplit inputFilePath outputFilePath encoding");
